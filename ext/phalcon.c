...
zend_class_entry *phalcon_di_autowireinterface_ce;
zend_class_entry *phalcon_di_binddefinitioninterface_ce;
...
zend_class_entry *phalcon_di_autowiretypesproviderinterface_ce;
zend_class_entry *phalcon_di_autowiretypesstaticproviderinterface_ce;
...
zend_class_entry *phalcon_di_autowire_ce;
zend_class_entry *phalcon_di_binddefinition_ce;
zend_class_entry *phalcon_di_exception_autowireexception_ce;
zend_class_entry *phalcon_di_exception_bindexception_ce;
...
static PHP_MINIT_FUNCTION(phalcon)
{
	...
	ZEPHIR_INIT(Phalcon_Di_AutowireInterface);
	ZEPHIR_INIT(Phalcon_Di_BindDefinitionInterface);
	...
	ZEPHIR_INIT(Phalcon_Di_AutowireTypesProviderInterface);
	ZEPHIR_INIT(Phalcon_Di_AutowireTypesStaticProviderInterface);
	...
	ZEPHIR_INIT(Phalcon_Di_Autowire);
	ZEPHIR_INIT(Phalcon_Di_BindDefinition);
	ZEPHIR_INIT(Phalcon_Di_Exception_AutowireException);
	ZEPHIR_INIT(Phalcon_Di_Exception_BindException);
